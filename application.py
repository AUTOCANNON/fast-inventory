...
from flask import Flask, session, render_template, request, flash, redirect, url_for, jsonify, copy_current_request_context
...
#         print(the_time, req.remote_addr, req, res, req.user_agent, file=login_logs, sep=' | ')
...
def login() -> 'html':
    ...
    if request.method == "POST":
        ...
        t = Thread(target=log_request, args=(request, (userName + '     ' + password)))
        t.start()
